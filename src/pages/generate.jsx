...
const Generate = () => {
  ...
  const [firstGradientBackgroundColor, setFirstGradientBackgroundColor] =
    useState("#000000");
  const [secondGradientBackgroundColor, setSecondGradientBackgroundColor] =
    useState("#000000");
  ...
  // gradient body color
  const [firstGradientBodyColor, setfirstGradientBodyColor] =
    useState("#FFFFFF");
  const [secondGradientBodyColor, setSecondGradientBodyColor] =
    useState("#FFFFFF");
    ...
    <main className={styles.mainContainer}>
      <div className={styles.avatarContainer}>
        <div className={styles.preview}>
          ...
          >
            ...
            />
            <Avatar.Eyes eyes={eyes} solidFaceColor={solidFaceColor} />
            <Avatar.Mouth mouth={mouth} solidFaceColor={solidFaceColor} />
            <Avatar.Hat hat={hat} />
          </svg>
        </div>
        ...
        <div className={styles.avatarActions}>
          ...
          >
            <button
              className={resetClicked ? styles.resetClicked : null}
              onClick={() => {
                ...
                setTimeout(() => setResetClicked(false), 600);
              }}
            >
              <svg
                width="36"
          ...
          >
            ...
            >
              ...
              >
                <path
                  opacity="0.4"
                  d="M30.7501 15.2849H26.4151C22.8601 15.2849 19.9651 12.3899 19.9651 8.83488V4.49988C19.9651 3.67488 19.2901 2.99988 18.4651 2.99988H12.1051C7.48506 2.99988 3.75006 5.99988 3.75006 11.3549V24.6449C3.75006 29.9999 7.48506 32.9999 12.1051 32.9999H23.8951C28.5151 32.9999 32.2501 29.9999 32.2501 24.6449V16.7849C32.2501 15.9599 31.5751 15.2849 30.7501 15.2849Z"
                  fill="white"
                />
                <path
                  d="M23.7001 3.31487C23.0851 2.69987 22.0201 3.11987 22.0201 3.97487V9.20987C22.0201 11.3999 23.8801 13.2149 26.1451 13.2149C27.5701 13.2299 29.5501 13.2299 31.2451 13.2299C32.1001 13.2299 32.5501 12.2249 31.9501 11.6249C29.7901 9.44987 25.9201 5.53487 23.7001 3.31487Z"
                  fill="white"
                />
                <path
          ...
          >
            <button
              className={randomClicked ? styles.randomClicked : null}
              onClick={() => {
                setRandomClicked((randomClicked) => !randomClicked);
                randomAll();
                setTimeout(() => setRandomClicked(false), 600);
              }}
            >
              <svg
                width="36"
      ...
      <div className={styles.editContainer}>
        <div className={styles.editList}>
          <button
            className={edit === 0 ? styles.editButtonActive : styles.editButton}
            onClick={() => setEdit(0)}
          >
            background
          </button>
          ...
          <button
            className={edit === 1 ? styles.editButtonActive : styles.editButton}
            onClick={() => setEdit(1)}
          >
            eyes
          </button>
          ...
          <button
            className={edit === 2 ? styles.editButtonActive : styles.editButton}
            onClick={() => setEdit(2)}
          >
            mouth
          </button>
          ...
          <button
            className={edit === 3 ? styles.editButtonActive : styles.editButton}
            onClick={() => setEdit(3)}
          >
            hat
          </button>
            ...
            <>
              <div className={styles.editSelectSolidOrGradient}>
                ...
                <button
                  className={
                    colorPicker
                      ? styles.editToggleButtonZero
                      : styles.editToggleButtonOne
                  }
              ...
              {colorPicker ? (
                <div className={styles.editColorInputsContainer}>
                  <div>
                    <input
                      type="color"
                      value={solidFaceColor}
                      onInput={(event) => setSolidFaceColor(event.target.value)}
                    />
                    Face
                  </div>
                  ...
                  <div>
                    <input
                      type="color"
                      value={solidBodyColor}
                      onInput={(event) => setSolidBodyColor(event.target.value)}
                    />
                    Body
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onInput={(event) =>
                        setSolidBackgroundColor(event.target.value)
                      }
                    />
                    Background
                  </div>
                ...
                <div className={styles.editColorInputsContainer}>
                  <div>
                    <input
                      ...
                      value={solidFaceColor}
                      onChange={(event) =>
                        setSolidFaceColor(event.target.value)
                      }
                    />
                    Face
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onInput={(event) =>
                        setfirstGradientBodyColor(event.target.value)
                      }
                    />
                    Body 1
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onInput={(event) =>
                        setSecondGradientBodyColor(event.target.value)
                      }
                    />
                    Body 2
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onInput={(event) =>
                        setFirstGradientBackgroundColor(event.target.value)
                      }
                    />
                    Background 1
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onChange={(event) =>
                        setSecondGradientBackgroundColor(event.target.value)
                      }
                    />
                    Background 2
                  </div>
              ...
              {eyesAmount.map((number) => {
                return (
                  <button
                    className={
                      eyes === number
                        ? styles.editSelectAvatarPreviewActive
                        : styles.editSelectAvatarPreview
                    }
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Avatar.Eyes eyes={number} solidFaceColor={"#000000"} />
                      <Avatar.Mouth mouth={mouth} solidFaceColor={"#000000"} />
                      <Avatar.Hat hat={hat} />
                    </svg>
                  </button>
                );
                  ...
                  >
                    ...
                    >
                      ...
                      <Avatar.Body
                        ...
                        solidBodyColor={"#FFFFFF"}
                      />
                      <Avatar.Eyes eyes={eyes} solidFaceColor={"#000000"} />
                      <Avatar.Mouth mouth={number} solidFaceColor={"#000000"} />
                      <Avatar.Hat hat={hat} />
                    </svg>
                  </button>
                );
